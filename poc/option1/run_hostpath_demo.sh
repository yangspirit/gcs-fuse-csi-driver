...
if [ ! -f hostpath-deployment.yaml ]; then
  echo -e "${YELLOW}Warning: hostpath-deployment.yaml not found in current directory.${NC}"
...
kubectl apply -f install-hostpath-binary.yaml
